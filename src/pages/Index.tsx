...
const tools = [
  { name: "NEXO REDATOR", icon: <PenTool {...iconProps} />, status: "active" as const, { name: "NEXO REDATOR", icon: <PenTool {...iconProps} />, status: "active" as const, url: "https://redator.nexosaude.med.br/", tooltip: "Documentos institucionais", top: 15, left: 360 },, tooltip: "Documentos institucionais", top: 15, left: 360 },
